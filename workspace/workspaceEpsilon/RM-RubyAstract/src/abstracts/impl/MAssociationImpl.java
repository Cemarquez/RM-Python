 ...
 *   <li>{@link abstracts.impl.MAssociationImpl#getNavegabilitySource <em>Navegability Source</em>}</li>
 *   <li>{@link abstracts.impl.MAssociationImpl#getNavegabilityTarget <em>Navegability Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MAssociationImpl extends EObjectImpl implements MAssociation {
	...
	public void setNavegabilitySource(String newNavegabilitySource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractsPackage.MASSOCIATION__NAVEGABILITY_SOURCE, oldNavegabilitySource, navegabilitySource));
	}
	...
	public void setNavegabilityTarget(String newNavegabilityTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractsPackage.MASSOCIATION__NAVEGABILITY_TARGET, oldNavegabilityTarget, navegabilityTarget));
	}
