 ...
 * @generated
 */
public class MFunctionNameReturnTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MFunctionNameReturnTypeEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = ConcreteParserProvider.getParser(ConcreteElementTypes.MFunction_3002, getParserElement(),
					ConcreteVisualIDRegistry
							.getType(concrete.diagram.edit.parts.MFunctionNameReturnTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
