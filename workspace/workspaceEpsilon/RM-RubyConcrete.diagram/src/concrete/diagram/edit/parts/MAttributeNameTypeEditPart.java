 ...
 * @generated
 */
public class MAttributeNameTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MAttributeNameTypeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ConcreteParserProvider.getParser(ConcreteElementTypes.MAttribute_3001, getParserElement(),
					ConcreteVisualIDRegistry.getType(concrete.diagram.edit.parts.MAttributeNameTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
