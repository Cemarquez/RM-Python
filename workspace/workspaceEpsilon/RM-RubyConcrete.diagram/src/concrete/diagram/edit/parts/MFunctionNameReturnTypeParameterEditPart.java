 ...
 * @generated
 */
public class MFunctionNameReturnTypeParameterEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MFunctionNameReturnTypeParameterEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = ConcreteParserProvider.getParser(ConcreteElementTypes.MFunction_3002, getParserElement(),
					ConcreteVisualIDRegistry
							.getType(concrete.diagram.edit.parts.MFunctionNameReturnTypeParameterEditPart.VISUAL_ID));
		}
		return parser;
	}
