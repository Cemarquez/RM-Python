 ...
 * @generated
 */
public class MFunctionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MFunctionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ConcreteParserProvider.getParser(ConcreteElementTypes.MFunction_3002, getParserElement(),
					ConcreteVisualIDRegistry.getType(concrete.diagram.edit.parts.MFunctionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
