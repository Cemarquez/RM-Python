 ...
 * @generated
 */
public class MRelationshipReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public MRelationshipReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return ConcreteBaseItemSemanticEditPolicy.getLinkConstraints().canExistMRelationship_4001(container, getLink(),
				getNewSource(), target);
	}
