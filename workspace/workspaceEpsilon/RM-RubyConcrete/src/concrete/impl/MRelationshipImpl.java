 ...
 * </p>
 * <ul>
 *   <li>{@link concrete.impl.MRelationshipImpl#getSource <em>Source</em>}</li>
 *   <li>{@link concrete.impl.MRelationshipImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link concrete.impl.MRelationshipImpl#getRelationshipType <em>Relationship Type</em>}</li>
 *   <li>{@link concrete.impl.MRelationshipImpl#getMultiplicitySource <em>Multiplicity Source</em>}</li>
 *   <li>{@link concrete.impl.MRelationshipImpl#getMultiplicityTarget <em>Multiplicity Target</em>}</li>
 *   <li>{@link concrete.impl.MRelationshipImpl#getSourceRole <em>Source Role</em>}</li>
 *   <li>{@link concrete.impl.MRelationshipImpl#getTargetRole <em>Target Role</em>}</li>
 *   <li>{@link concrete.impl.MRelationshipImpl#getNavegabilitySource <em>Navegability Source</em>}</li>
 *   <li>{@link concrete.impl.MRelationshipImpl#getNavegabilityTarget <em>Navegability Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MRelationshipImpl extends EObjectImpl implements MRelationship {
	...
	protected EClass eStaticClass() {
		return ConcretePackage.Literals.MRELATIONSHIP;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConcretePackage.MRELATIONSHIP__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(MClass newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretePackage.MRELATIONSHIP__SOURCE, oldSource, source));
	}
	...
	public MClass getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConcretePackage.MRELATIONSHIP__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(MClass newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretePackage.MRELATIONSHIP__TARGET, oldTarget, target));
	}
	...
	public void setRelationshipType(String newRelationshipType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretePackage.MRELATIONSHIP__RELATIONSHIP_TYPE, oldRelationshipType, relationshipType));
	}
	...
	public void setMultiplicitySource(String newMultiplicitySource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretePackage.MRELATIONSHIP__MULTIPLICITY_SOURCE, oldMultiplicitySource, multiplicitySource));
	}
	...
	public void setMultiplicityTarget(String newMultiplicityTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretePackage.MRELATIONSHIP__MULTIPLICITY_TARGET, oldMultiplicityTarget, multiplicityTarget));
	}
	...
	public void setSourceRole(String newSourceRole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretePackage.MRELATIONSHIP__SOURCE_ROLE, oldSourceRole, sourceRole));
	}
	...
	public void setTargetRole(String newTargetRole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretePackage.MRELATIONSHIP__TARGET_ROLE, oldTargetRole, targetRole));
	}
	...
	public void setNavegabilitySource(String newNavegabilitySource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretePackage.MRELATIONSHIP__NAVEGABILITY_SOURCE, oldNavegabilitySource, navegabilitySource));
	}
	...
	public void setNavegabilityTarget(String newNavegabilityTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretePackage.MRELATIONSHIP__NAVEGABILITY_TARGET, oldNavegabilityTarget, navegabilityTarget));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ConcretePackage.MRELATIONSHIP__SOURCE:
				if (resolve) return getSource();
				return basicGetSource();
			case ConcretePackage.MRELATIONSHIP__TARGET:
				if (resolve) return getTarget();
				return basicGetTarget();
			case ConcretePackage.MRELATIONSHIP__RELATIONSHIP_TYPE:
				return getRelationshipType();
			case ConcretePackage.MRELATIONSHIP__MULTIPLICITY_SOURCE:
				return getMultiplicitySource();
			case ConcretePackage.MRELATIONSHIP__MULTIPLICITY_TARGET:
				return getMultiplicityTarget();
			case ConcretePackage.MRELATIONSHIP__SOURCE_ROLE:
				return getSourceRole();
			case ConcretePackage.MRELATIONSHIP__TARGET_ROLE:
				return getTargetRole();
			case ConcretePackage.MRELATIONSHIP__NAVEGABILITY_SOURCE:
				return getNavegabilitySource();
			case ConcretePackage.MRELATIONSHIP__NAVEGABILITY_TARGET:
