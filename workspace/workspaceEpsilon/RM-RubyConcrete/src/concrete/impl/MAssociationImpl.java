 ...
 *   <li>{@link concrete.impl.MAssociationImpl#getRelationshipType <em>Relationship Type</em>}</li>
...
public class MAssociationImpl extends EObjectImpl implements MAssociation {
	...
	public void setRelationshipType(String newRelationshipType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretePackage.MASSOCIATION__RELATIONSHIP_TYPE, oldRelationshipType, relationshipType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ConcretePackage.MASSOCIATION__RELATIONSHIP_TYPE:
