...
public class FilesystemPaletteFactory {
	...
	*/
	private ToolEntry createDrive1CreationTool() {
		...
		entry.setSmallIcon(FilesystemElementTypes.getImageDescriptor(FilesystemElementTypes.Drive_2001));
	...
	*/
	private ToolEntry createFile2CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(Messages.File2CreationTool_title,
				Messages.File2CreationTool_desc, Collections.singletonList(FilesystemElementTypes.File_3004));
		entry.setId("createFile2CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(FilesystemElementTypes.getImageDescriptor(FilesystemElementTypes.File_3004));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	*/
	private ToolEntry createFolder3CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(Messages.Folder3CreationTool_title,
				Messages.Folder3CreationTool_desc, Collections.singletonList(FilesystemElementTypes.Folder_3002));
		entry.setId("createFolder3CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(FilesystemElementTypes.getImageDescriptor(FilesystemElementTypes.Folder_3002));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	*/
	private ToolEntry createShortcut4CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(Messages.Shortcut4CreationTool_title,
				Messages.Shortcut4CreationTool_desc, Collections.singletonList(FilesystemElementTypes.Shortcut_3003));
		entry.setId("createShortcut4CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(FilesystemElementTypes.getImageDescriptor(FilesystemElementTypes.Shortcut_3003));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	*/
	private ToolEntry createSync1CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(Messages.Sync1CreationTool_title,
				Messages.Sync1CreationTool_desc, Collections.singletonList(FilesystemElementTypes.Sync_4001));
		entry.setId("createSync1CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(FilesystemElementTypes.getImageDescriptor(FilesystemElementTypes.Sync_4001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	*/
	private ToolEntry createTarget2CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(Messages.Target2CreationTool_title,
				...
				Collections.singletonList(FilesystemElementTypes.ShortcutTarget_4002));
		entry.setId("createTarget2CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(FilesystemElementTypes.getImageDescriptor(FilesystemElementTypes.ShortcutTarget_4002));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
