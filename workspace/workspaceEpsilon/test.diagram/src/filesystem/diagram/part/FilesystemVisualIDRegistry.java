...
public class FilesystemVisualIDRegistry {
	...
	* @generated
	*/
	private static final String DEBUG_KEY = "test.diagram/debug/visualID"; //$NON-NLS-1$
	...
	*/
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		if (!FilesystemEditPart.MODEL_ID.equals(containerModelID) && !"filesystem".equals(containerModelID)) { //$NON-NLS-1$
			return -1;
		}
		...
		case FilesystemEditPart.VISUAL_ID:
			if (FilesystemPackage.eINSTANCE.getDrive().isSuperTypeOf(domainElement.eClass())) {
		...
		case DriveDriveContentsCompartmentEditPart.VISUAL_ID:
			...
			if (FilesystemPackage.eINSTANCE.getShortcut().isSuperTypeOf(domainElement.eClass())) {
	...
	*/
	public static int getLinkWithClassVisualID(EObject domainElement) {
		...
		if (FilesystemPackage.eINSTANCE.getSync().isSuperTypeOf(domainElement.eClass())) {
