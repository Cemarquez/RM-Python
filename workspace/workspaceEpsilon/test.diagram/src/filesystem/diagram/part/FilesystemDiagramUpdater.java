...
public class FilesystemDiagramUpdater {
	...
	* @generated
	*/
	public static List<FilesystemNodeDescriptor> getDriveDriveContentsCompartment_7001SemanticChildren(View view) {
	...
	* @generated
	*/
	public static List<FilesystemNodeDescriptor> getDriveDriveContentsCompartment_7002SemanticChildren(View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.emptyList();
		}
		View containerView = (View) view.eContainer();
	...
	* @generated
	*/
	public static List<FilesystemNodeDescriptor> getFolderFolderContentsCompartment_7003SemanticChildren(View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.emptyList();
		}
		View containerView = (View) view.eContainer();
	...
	*/
	 ...
	 * @generated
	 */
	public static List<FilesystemLinkDescriptor> getDrive_2001ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<FilesystemLinkDescriptor> getDrive_3001ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<FilesystemLinkDescriptor> getFolder_3002ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<FilesystemLinkDescriptor> getShortcut_3003ContainedLinks(View view) {
	 ...
	 * @generated
	 */
	public static List<FilesystemLinkDescriptor> getFile_3004ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<FilesystemLinkDescriptor> getSync_4001ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<FilesystemLinkDescriptor> getDrive_2001IncomingLinks(View view) {
	 ...
	 * @generated
	 */
	public static List<FilesystemLinkDescriptor> getDrive_3001IncomingLinks(View view) {
		Drive modelElement = (Drive) view.getElement();
		Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences = EcoreUtil.CrossReferencer
				.find(view.eResource().getResourceSet().getResources());
		LinkedList<FilesystemLinkDescriptor> result = new LinkedList<FilesystemLinkDescriptor>();
	 ...
	 * @generated
	 */
	public static List<FilesystemLinkDescriptor> getFolder_3002IncomingLinks(View view) {
	 ...
	 * @generated
	 */
	public static List<FilesystemLinkDescriptor> getShortcut_3003IncomingLinks(View view) {
		Shortcut modelElement = (Shortcut) view.getElement();
		Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences = EcoreUtil.CrossReferencer
				.find(view.eResource().getResourceSet().getResources());
		LinkedList<FilesystemLinkDescriptor> result = new LinkedList<FilesystemLinkDescriptor>();
	 ...
	 * @generated
	 */
	public static List<FilesystemLinkDescriptor> getFile_3004IncomingLinks(View view) {
	 ...
	 * @generated
	 */
	public static List<FilesystemLinkDescriptor> getSync_4001IncomingLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<FilesystemLinkDescriptor> getDrive_2001OutgoingLinks(View view) {
		Drive modelElement = (Drive) view.getElement();
		LinkedList<FilesystemLinkDescriptor> result = new LinkedList<FilesystemLinkDescriptor>();
	 ...
	 * @generated
	 */
	public static List<FilesystemLinkDescriptor> getDrive_3001OutgoingLinks(View view) {
		Drive modelElement = (Drive) view.getElement();
		LinkedList<FilesystemLinkDescriptor> result = new LinkedList<FilesystemLinkDescriptor>();
		result.addAll(getOutgoingTypeModelFacetLinks_Sync_4001(modelElement));
		return result;
	 ...
	 * @generated
	 */
	public static List<FilesystemLinkDescriptor> getFolder_3002OutgoingLinks(View view) {
		Folder modelElement = (Folder) view.getElement();
		LinkedList<FilesystemLinkDescriptor> result = new LinkedList<FilesystemLinkDescriptor>();
		result.addAll(getOutgoingTypeModelFacetLinks_Sync_4001(modelElement));
		return result;
	 ...
	 * @generated
	 */
	public static List<FilesystemLinkDescriptor> getShortcut_3003OutgoingLinks(View view) {
		Shortcut modelElement = (Shortcut) view.getElement();
		LinkedList<FilesystemLinkDescriptor> result = new LinkedList<FilesystemLinkDescriptor>();
		result.addAll(getOutgoingTypeModelFacetLinks_Sync_4001(modelElement));
		result.addAll(getOutgoingFeatureModelFacetLinks_Shortcut_Target_4002(modelElement));
	 ...
	 * @generated
	 */
	public static List<FilesystemLinkDescriptor> getFile_3004OutgoingLinks(View view) {
		File modelElement = (File) view.getElement();
		LinkedList<FilesystemLinkDescriptor> result = new LinkedList<FilesystemLinkDescriptor>();
		result.addAll(getOutgoingTypeModelFacetLinks_Sync_4001(modelElement));
		return result;
	 ...
	 * @generated
	 */
	public static List<FilesystemLinkDescriptor> getSync_4001OutgoingLinks(View view) {
		return Collections.emptyList();
	}
	...
	*/
	private static Collection<FilesystemLinkDescriptor> getContainedTypeModelFacetLinks_Sync_4001(
		...
		for (Iterator<?> links = container.getSyncs().iterator(); links.hasNext();) {
			...
			if (SyncEditPart.VISUAL_ID != FilesystemVisualIDRegistry.getLinkWithClassVisualID(link)) {
				continue;
			}
			File dst = link.getTarget();
			File src = link.getSource();
			result.add(new FilesystemLinkDescriptor(src, dst, link, FilesystemElementTypes.Sync_4001,
					SyncEditPart.VISUAL_ID));
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection<FilesystemLinkDescriptor> getIncomingTypeModelFacetLinks_Sync_4001(File target,
			Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<FilesystemLinkDescriptor> result = new LinkedList<FilesystemLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences.get(target);
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() != FilesystemPackage.eINSTANCE.getSync_Target()
			...
			File src = link.getSource();
			result.add(new FilesystemLinkDescriptor(src, target, link, FilesystemElementTypes.Sync_4001,
					SyncEditPart.VISUAL_ID));
		}
		return result;
	}
	...
	private static Collection<FilesystemLinkDescriptor> getIncomingFeatureModelFacetLinks_Shortcut_Target_4002(
		...
		Collection<EStructuralFeature.Setting> settings = crossReferences.get(target);
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() == FilesystemPackage.eINSTANCE.getShortcut_Target()) {
				result.add(new FilesystemLinkDescriptor(setting.getEObject(), target,
						FilesystemElementTypes.ShortcutTarget_4002, ShortcutTargetEditPart.VISUAL_ID));
			}
		}
		return result;
	}
	...
	* @generated
	*/
	private static Collection<FilesystemLinkDescriptor> getOutgoingTypeModelFacetLinks_Sync_4001(File source) {
	...
	*/
	private static Collection<FilesystemLinkDescriptor> getOutgoingFeatureModelFacetLinks_Shortcut_Target_4002(
		...
		result.add(new FilesystemLinkDescriptor(source, destination, FilesystemElementTypes.ShortcutTarget_4002,
