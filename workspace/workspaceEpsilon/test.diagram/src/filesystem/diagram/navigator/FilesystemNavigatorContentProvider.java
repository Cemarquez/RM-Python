	...
	*/
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case FilesystemEditPart.VISUAL_ID: {
			...
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					FilesystemVisualIDRegistry.getType(ShortcutTargetEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			if (!links.isEmpty()) {
				result.add(links);
			}
		...
		case DriveEditPart.VISUAL_ID: {
			...
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
					FilesystemVisualIDRegistry.getType(DriveDriveContentsCompartmentEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					FilesystemVisualIDRegistry.getType(Drive2EditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					FilesystemVisualIDRegistry.getType(DriveDriveContentsCompartmentEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
			...
			connectedViews = getChildrenByType(Collections.singleton(sv),
					FilesystemVisualIDRegistry.getType(DriveDriveContentsCompartmentEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					FilesystemVisualIDRegistry.getType(ShortcutEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					FilesystemVisualIDRegistry.getType(DriveDriveContentsCompartmentEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
		...
		case Drive2EditPart.VISUAL_ID: {
			...
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
					FilesystemVisualIDRegistry.getType(DriveDriveContentsCompartment2EditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					FilesystemVisualIDRegistry.getType(Drive2EditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
		...
		case FolderEditPart.VISUAL_ID: {
			...
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
					FilesystemVisualIDRegistry.getType(FolderFolderContentsCompartmentEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					FilesystemVisualIDRegistry.getType(Drive2EditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
		...
		case SyncEditPart.VISUAL_ID: {
			LinkedList<FilesystemAbstractNavigatorItem> result = new LinkedList<FilesystemAbstractNavigatorItem>();
			Edge sv = (Edge) view;
			FilesystemNavigatorGroup target = new FilesystemNavigatorGroup(Messages.NavigatorGroupName_Sync_4001_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			FilesystemNavigatorGroup source = new FilesystemNavigatorGroup(Messages.NavigatorGroupName_Sync_4001_source,
