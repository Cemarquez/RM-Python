...
public class FilesystemNavigatorLabelProvider extends LabelProvider
	...
	*/
	public Image getImage(View view) {
		...
		case FilesystemEditPart.VISUAL_ID:
			return getImage("Navigator?Diagram?filesystem?Filesystem", FilesystemElementTypes.Filesystem_1000); //$NON-NLS-1$
		case DriveEditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?filesystem?Drive", FilesystemElementTypes.Drive_2001); //$NON-NLS-1$
		case Drive2EditPart.VISUAL_ID:
			return getImage("Navigator?Node?filesystem?Drive", FilesystemElementTypes.Drive_3001); //$NON-NLS-1$
		case FolderEditPart.VISUAL_ID:
			return getImage("Navigator?Node?filesystem?Folder", FilesystemElementTypes.Folder_3002); //$NON-NLS-1$
		case ShortcutEditPart.VISUAL_ID:
			return getImage("Navigator?Node?filesystem?Shortcut", FilesystemElementTypes.Shortcut_3003); //$NON-NLS-1$
		case FileEditPart.VISUAL_ID:
			return getImage("Navigator?Node?filesystem?File", FilesystemElementTypes.File_3004); //$NON-NLS-1$
		case SyncEditPart.VISUAL_ID:
			return getImage("Navigator?Link?filesystem?Sync", FilesystemElementTypes.Sync_4001); //$NON-NLS-1$
		case ShortcutTargetEditPart.VISUAL_ID:
			return getImage("Navigator?Link?filesystem?Shortcut?target", FilesystemElementTypes.ShortcutTarget_4002); //$NON-NLS-1$
		}
	...
	*/
	private String getDrive_2001Text(View view) {
		IParser parser = FilesystemParserProvider.getParser(FilesystemElementTypes.Drive_2001,
	...
	*/
	private String getDrive_3001Text(View view) {
		IParser parser = FilesystemParserProvider.getParser(FilesystemElementTypes.Drive_3001,
				view.getElement() != null ? view.getElement() : view,
				FilesystemVisualIDRegistry.getType(DriveName2EditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
		} else {
	...
	*/
	private String getFolder_3002Text(View view) {
		IParser parser = FilesystemParserProvider.getParser(FilesystemElementTypes.Folder_3002,
				view.getElement() != null ? view.getElement() : view,
	...
	*/
	private String getShortcut_3003Text(View view) {
		IParser parser = FilesystemParserProvider.getParser(FilesystemElementTypes.Shortcut_3003,
				view.getElement() != null ? view.getElement() : view,
				FilesystemVisualIDRegistry.getType(ShortcutNameEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
		} else {
	...
	*/
	private String getFile_3004Text(View view) {
		IParser parser = FilesystemParserProvider.getParser(FilesystemElementTypes.File_3004,
				view.getElement() != null ? view.getElement() : view,
	...
	*/
	private String getShortcutTarget_4002Text(View view) {
		IParser parser = FilesystemParserProvider.getParser(FilesystemElementTypes.ShortcutTarget_4002,
				view.getElement() != null ? view.getElement() : view, CommonParserHint.DESCRIPTION);
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
		} else {
			FilesystemDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6001); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
