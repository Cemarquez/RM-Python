...
public class FilesystemCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return DriveEditPart.VISUAL_ID == FilesystemVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	private Collection<FilesystemLinkDescriptor> collectAllLinks(View view, Domain2Notation domain2NotationMap) {
		...
		case DriveEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(FilesystemDiagramUpdater.getDrive_2001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case Drive2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(FilesystemDiagramUpdater.getDrive_3001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case FolderEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(FilesystemDiagramUpdater.getFolder_3002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case ShortcutEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(FilesystemDiagramUpdater.getShortcut_3003ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case FileEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(FilesystemDiagramUpdater.getFile_3004ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case SyncEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(FilesystemDiagramUpdater.getSync_4001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
