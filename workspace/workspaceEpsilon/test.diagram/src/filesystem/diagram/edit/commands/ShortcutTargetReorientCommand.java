...
public class ShortcutTargetReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return FilesystemBaseItemSemanticEditPolicy.getLinkConstraints().canExistShortcutTarget_4002(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return FilesystemBaseItemSemanticEditPolicy.getLinkConstraints().canExistShortcutTarget_4002(getOldSource(),
				getNewTarget());
	}
