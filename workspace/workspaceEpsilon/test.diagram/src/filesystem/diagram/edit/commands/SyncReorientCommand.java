...
public class SyncReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return FilesystemBaseItemSemanticEditPolicy.getLinkConstraints().canExistSync_4001(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		Filesystem container = (Filesystem) getLink().eContainer();
		return FilesystemBaseItemSemanticEditPolicy.getLinkConstraints().canExistSync_4001(container, getLink(), source,
				getNewTarget());
	}
