...
public class FilesystemElementTypes {
	...
	* @generated
	*/
	public static final IElementType Filesystem_1000 = getElementType("test.diagram.Filesystem_1000"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType Drive_2001 = getElementType("test.diagram.Drive_2001"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType Drive_3001 = getElementType("test.diagram.Drive_3001"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType Folder_3002 = getElementType("test.diagram.Folder_3002"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType Shortcut_3003 = getElementType("test.diagram.Shortcut_3003"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType File_3004 = getElementType("test.diagram.File_3004"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType Sync_4001 = getElementType("test.diagram.Sync_4001"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType ShortcutTarget_4002 = getElementType("test.diagram.ShortcutTarget_4002"); //$NON-NLS-1$
	...
	*/
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(Shortcut_3003, FilesystemPackage.eINSTANCE.getShortcut());

			elements.put(File_3004, FilesystemPackage.eINSTANCE.getFile());

			elements.put(Sync_4001, FilesystemPackage.eINSTANCE.getSync());

			elements.put(ShortcutTarget_4002, FilesystemPackage.eINSTANCE.getShortcut_Target());
		}
