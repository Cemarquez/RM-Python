/**
 */
package diagrama.domain.concretesyntax.provider;
...
/**
 * This is the item provider adapter for a {@link diagrama.domain.concretesyntax.ConcreteSyntax} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConcreteSyntaxItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConcretesyntaxPackage.Literals.CONCRETE_SYNTAX__LST_MCLASS_DIAGRAM);
		}
	...
	public String getText(Object object) {
		return getString("_UI_ConcreteSyntax_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConcretesyntaxPackage.Literals.CONCRETE_SYNTAX__LST_MCLASS_DIAGRAM,
				 AbstractsyntaxFactory.eINSTANCE.createMClassDiagram()));
	}
