...
/**
 * This is the action bar contributor for the Concretesyntax model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConcretesyntaxActionBarContributor
	 ...
	 * @generated
	 */
	public ConcretesyntaxActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("concretesyntax-settings"));
		toolBarManager.add(new Separator("concretesyntax-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(ModelEditorPlugin.INSTANCE.getString("_UI_ConcretesyntaxEditor_menu"), "diagrama.domain.concretesyntaxMenuID");
