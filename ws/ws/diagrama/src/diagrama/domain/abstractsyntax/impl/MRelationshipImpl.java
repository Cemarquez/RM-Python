 ...
 * </p>
 * <ul>
 *   <li>{@link diagrama.domain.abstractsyntax.impl.MRelationshipImpl#getSource <em>Source</em>}</li>
 *   <li>{@link diagrama.domain.abstractsyntax.impl.MRelationshipImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link diagrama.domain.abstractsyntax.impl.MRelationshipImpl#getOwnedByMClass <em>Owned By MClass</em>}</li>
 *   <li>{@link diagrama.domain.abstractsyntax.impl.MRelationshipImpl#getRelationshipType <em>Relationship Type</em>}</li>
 *   <li>{@link diagrama.domain.abstractsyntax.impl.MRelationshipImpl#getMultiplicitySource <em>Multiplicity Source</em>}</li>
 *   <li>{@link diagrama.domain.abstractsyntax.impl.MRelationshipImpl#getMultiplicityTarget <em>Multiplicity Target</em>}</li>
 *   <li>{@link diagrama.domain.abstractsyntax.impl.MRelationshipImpl#getSourceRole <em>Source Role</em>}</li>
 *   <li>{@link diagrama.domain.abstractsyntax.impl.MRelationshipImpl#getTargetRole <em>Target Role</em>}</li>
 *   <li>{@link diagrama.domain.abstractsyntax.impl.MRelationshipImpl#getLstRelationshipFactory <em>Lst Relationship Factory</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MRelationshipImpl extends EObjectImpl implements MRelationship {
	...
	protected EClass eStaticClass() {
		return AbstractsyntaxPackage.Literals.MRELATIONSHIP;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AbstractsyntaxPackage.MRELATIONSHIP__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public NotificationChain basicSetSource(MClass newSource, NotificationChain msgs) {
		...
		source = newSource;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AbstractsyntaxPackage.MRELATIONSHIP__SOURCE, oldSource, newSource);
	...
	public void setSource(MClass newSource) {
		if (newSource != source) {
			...
			if (source != null)
				msgs = ((InternalEObject)source).eInverseRemove(this, AbstractsyntaxPackage.MCLASS__LST_MRELATIONSHIP_SOURCE, MClass.class, msgs);
			if (newSource != null)
				msgs = ((InternalEObject)newSource).eInverseAdd(this, AbstractsyntaxPackage.MCLASS__LST_MRELATIONSHIP_SOURCE, MClass.class, msgs);
			msgs = basicSetSource(newSource, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractsyntaxPackage.MRELATIONSHIP__SOURCE, newSource, newSource));
	}
	...
	public MClass getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AbstractsyntaxPackage.MRELATIONSHIP__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public NotificationChain basicSetTarget(MClass newTarget, NotificationChain msgs) {
		...
		target = newTarget;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AbstractsyntaxPackage.MRELATIONSHIP__TARGET, oldTarget, newTarget);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTarget(MClass newTarget) {
		if (newTarget != target) {
			NotificationChain msgs = null;
			if (target != null)
				msgs = ((InternalEObject)target).eInverseRemove(this, AbstractsyntaxPackage.MCLASS__LST_MRELATIONSHIP_TARGET, MClass.class, msgs);
			if (newTarget != null)
				msgs = ((InternalEObject)newTarget).eInverseAdd(this, AbstractsyntaxPackage.MCLASS__LST_MRELATIONSHIP_TARGET, MClass.class, msgs);
			msgs = basicSetTarget(newTarget, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractsyntaxPackage.MRELATIONSHIP__TARGET, newTarget, newTarget));
	}
	...
	public MClass getOwnedByMClass() {
		if (eContainerFeatureID() != AbstractsyntaxPackage.MRELATIONSHIP__OWNED_BY_MCLASS) return null;
	...
	public NotificationChain basicSetOwnedByMClass(MClass newOwnedByMClass, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newOwnedByMClass, AbstractsyntaxPackage.MRELATIONSHIP__OWNED_BY_MCLASS, msgs);
		return msgs;
	}
	...
	public void setOwnedByMClass(MClass newOwnedByMClass) {
		if (newOwnedByMClass != eInternalContainer() || (eContainerFeatureID() != AbstractsyntaxPackage.MRELATIONSHIP__OWNED_BY_MCLASS && newOwnedByMClass != null)) {
			...
			if (newOwnedByMClass != null)
				msgs = ((InternalEObject)newOwnedByMClass).eInverseAdd(this, AbstractsyntaxPackage.MCLASS__LST_MRELATIONSHIP, MClass.class, msgs);
			msgs = basicSetOwnedByMClass(newOwnedByMClass, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractsyntaxPackage.MRELATIONSHIP__OWNED_BY_MCLASS, newOwnedByMClass, newOwnedByMClass));
	}
	...
	public void setRelationshipType(String newRelationshipType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractsyntaxPackage.MRELATIONSHIP__RELATIONSHIP_TYPE, oldRelationshipType, relationshipType));
	}
	...
	public void setMultiplicitySource(String newMultiplicitySource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractsyntaxPackage.MRELATIONSHIP__MULTIPLICITY_SOURCE, oldMultiplicitySource, multiplicitySource));
	}
	...
	public void setMultiplicityTarget(String newMultiplicityTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractsyntaxPackage.MRELATIONSHIP__MULTIPLICITY_TARGET, oldMultiplicityTarget, multiplicityTarget));
	}
	...
	public void setSourceRole(String newSourceRole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractsyntaxPackage.MRELATIONSHIP__SOURCE_ROLE, oldSourceRole, sourceRole));
	}
	...
	public void setTargetRole(String newTargetRole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractsyntaxPackage.MRELATIONSHIP__TARGET_ROLE, oldTargetRole, targetRole));
	}
	...
	public RelationshipFactory getLstRelationshipFactory() {
		if (eContainerFeatureID() != AbstractsyntaxPackage.MRELATIONSHIP__LST_RELATIONSHIP_FACTORY) return null;
	...
	public NotificationChain basicSetLstRelationshipFactory(RelationshipFactory newLstRelationshipFactory, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newLstRelationshipFactory, AbstractsyntaxPackage.MRELATIONSHIP__LST_RELATIONSHIP_FACTORY, msgs);
		return msgs;
	}
	...
	public void setLstRelationshipFactory(RelationshipFactory newLstRelationshipFactory) {
		if (newLstRelationshipFactory != eInternalContainer() || (eContainerFeatureID() != AbstractsyntaxPackage.MRELATIONSHIP__LST_RELATIONSHIP_FACTORY && newLstRelationshipFactory != null)) {
			...
			if (newLstRelationshipFactory != null)
				msgs = ((InternalEObject)newLstRelationshipFactory).eInverseAdd(this, AbstractsyntaxPackage.RELATIONSHIP_FACTORY__LST_MRELATIONSHIP, RelationshipFactory.class, msgs);
			msgs = basicSetLstRelationshipFactory(newLstRelationshipFactory, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractsyntaxPackage.MRELATIONSHIP__LST_RELATIONSHIP_FACTORY, newLstRelationshipFactory, newLstRelationshipFactory));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AbstractsyntaxPackage.MRELATIONSHIP__SOURCE:
				if (source != null)
					msgs = ((InternalEObject)source).eInverseRemove(this, AbstractsyntaxPackage.MCLASS__LST_MRELATIONSHIP_SOURCE, MClass.class, msgs);
				return basicSetSource((MClass)otherEnd, msgs);
			case AbstractsyntaxPackage.MRELATIONSHIP__TARGET:
				if (target != null)
					msgs = ((InternalEObject)target).eInverseRemove(this, AbstractsyntaxPackage.MCLASS__LST_MRELATIONSHIP_TARGET, MClass.class, msgs);
				return basicSetTarget((MClass)otherEnd, msgs);
			case AbstractsyntaxPackage.MRELATIONSHIP__OWNED_BY_MCLASS:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetOwnedByMClass((MClass)otherEnd, msgs);
			case AbstractsyntaxPackage.MRELATIONSHIP__LST_RELATIONSHIP_FACTORY:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case AbstractsyntaxPackage.MRELATIONSHIP__OWNED_BY_MCLASS:
				return eInternalContainer().eInverseRemove(this, AbstractsyntaxPackage.MCLASS__LST_MRELATIONSHIP, MClass.class, msgs);
			case AbstractsyntaxPackage.MRELATIONSHIP__LST_RELATIONSHIP_FACTORY:
				return eInternalContainer().eInverseRemove(this, AbstractsyntaxPackage.RELATIONSHIP_FACTORY__LST_MRELATIONSHIP, RelationshipFactory.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case AbstractsyntaxPackage.MRELATIONSHIP__RELATIONSHIP_TYPE:
				return getRelationshipType();
			case AbstractsyntaxPackage.MRELATIONSHIP__MULTIPLICITY_SOURCE:
				return getMultiplicitySource();
			case AbstractsyntaxPackage.MRELATIONSHIP__MULTIPLICITY_TARGET:
				return getMultiplicityTarget();
			case AbstractsyntaxPackage.MRELATIONSHIP__SOURCE_ROLE:
				return getSourceRole();
			case AbstractsyntaxPackage.MRELATIONSHIP__TARGET_ROLE:
