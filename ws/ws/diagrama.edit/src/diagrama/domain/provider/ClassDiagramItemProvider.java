...
/**
 * This is the item provider adapter for a {@link diagrama.domain.ClassDiagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassDiagramItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DomainPackage.Literals.CLASS_DIAGRAM__LST_MCLASS);
			childrenFeatures.add(DomainPackage.Literals.CLASS_DIAGRAM__THE_RELATIONSHIP_FACTORY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.CLASS_DIAGRAM__LST_MCLASS,
				 DomainFactory.eINSTANCE.createMClass()));

		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.CLASS_DIAGRAM__THE_RELATIONSHIP_FACTORY,
				 DomainFactory.eINSTANCE.createRelationshipFactory()));
	}
