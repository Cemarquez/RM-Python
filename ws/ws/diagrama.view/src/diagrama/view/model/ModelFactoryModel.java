package diagrama.view.model;
import diagrama.view.*;
...
// Clase estatica oculta. Tan solo se instanciara el singleton una vez
   ...
   public static ModelFactoryModel getInstance()  { 
     ...
     ModelFactory modelFactory = diagramaFactory.eINSTANCE.createModelFactory();

   static String URL = "/test/src/model/model.diagrama";
